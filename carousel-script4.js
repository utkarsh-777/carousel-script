...
const themeTwo = `
<div style="width: 80%;margin: auto;border-radius: 10px;border: 1px solid {{%BACKGROUND_COLOR%}};margin-top: 20px;">
            <div>
                <div class="Polaris-Card">
                  <div class="Polaris-Card__Section">
                      <div>
...
const themeFour = `
<div style="width: 80%;margin: auto;background-color: white;font-family:Cormorant Garamond, serif;border-radius: 10px;border: 1px solid {{%BACKGROUND_COLOR%}};margin-top: 20px;margin-bottom: 20px;">
            <div class="Polaris-Card">
                <div class="Polaris-Card__Section">
                    <div class="Polaris-Stack">
                        <div class="Polaris-Stack__Item Polaris-Stack__Item--fill">
